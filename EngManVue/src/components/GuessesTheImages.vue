<template>
    <div>
        ...
        <div v-if = "show" class = "b-popup">
            <div class = "b-popup-content">
                <span 
                    ...
                    style = "padding: 0px; font-size: 14px; width: 50%; margin-left: 25%;" 
                    v-on:click = "showWordTranslate = true" 
                    title = "Show translate of word">
                    Show
                </span>

                <span 
                    class = "routes-admin pointer" 
                    v-else style = "padding: 0px; font-size: 14px; width: 50%; margin-left: 25%;" 
                    v-on:click = "showWordTranslate = false" 
                    title = "Hide translate of word">
                    {{task.Word.Translate}}
                </span>

                <span 
                    style = "float: right; font-size:10px; cursor: pointer" 
                    v-on:click = "closeForm(false); showWordTranslate = false;">
                        <img 
                            title="End" 
                ...
                <span 
                    style = "float: right; font-size:10px; cursor: pointer" 
                    v-on:click = "downloadTask(); showWordTranslate = false">
                        <img 
                            title="Next" 
                            style = "width: 20px; height: auto" 
                            type = "img" 
                ...
                <span 
                    style = "float: right; font-size:10px; cursor: pointer" 
                    v-on:click = "verificationCorrectness(); showWordTranslate = false">
                        <img 
                            title="Verification" 
                            style = "width: 20px; height: auto" 
                            type = "img" 
                ...
                <img 
                    title="Guess what's on the picture" 
                    :src = "task.Path" 
                    style = "width: 80%; margin-left: 10%; margin-bottom: 5px;">

                <input 
                    style = "border: none; border-radius:5px;box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.5); margin-bottom: 5px" 
                    type = "text" 
                    v-model = "task.Word.Original" 
        ...
        <div class="tasks-align">
            ...
            <span style = "font-size: 30px">Guess what's on the picture</span>
            <br/>
