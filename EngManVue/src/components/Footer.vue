<template>
  <div class="footer">
      ...
      <span v-if = "$store.state.user.Role" style = "position: fixed; bottom: 2.5%; right: 1%; cursor: pointer" v-on:click = "show = true">
        <img v-bind:class = "{'new-mes-in': $store.state.newmess}" title="Входящие сообщения" style = "width: 50px; height: auto" type = "img" src = "../assets/mes-icon.png">
        </span>
